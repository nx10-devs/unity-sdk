...
namespace NX10
{
    ...
    /// </summary>
    public abstract class NX10Singleton<T> : StaticInstance<T> where T : MonoBehaviour
    {
    ...
    /// </summary>
    public abstract class NX10PersistentSingleton<T> : NX10Singleton<T> where T : MonoBehaviour
    {
        protected override void Awake()
        {
            base.Awake();
